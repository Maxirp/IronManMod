...
void MobileColors::Read() {
	plugin::config_file config(PLUGIN_PATH("IronMan\\hudcolor.dat"));
	...
	HudColour.SetRGBAValue(HUD_COLOUR_BLUE, 0, 162, 232, 255); //HudBlue.r, HudBlue.g, HudBlue.b, HudBlue.a);
	HudColour.SetRGBAValue(HUD_COLOUR_YELLOW, 255, 255, 255, HudYellow.a);
	plugin::patch::SetInt(0x00725BD0, 0x00BA66, 1);
	plugin::patch::SetInt(0x00725BCC, 0xFFB966, 1);
	plugin::patch::SetInt(0x00725BD5, 0xFFB866, 1);
}